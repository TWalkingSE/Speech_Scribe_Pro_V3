...
class TestMainWindowSmoke:
    ...
    def test_import_batch_processor(self):
        ...
        from speech_scribe.gui.batch_processor import BatchItem, BatchProcessorWidget, DropListWidget
    ...
    def test_import_enhancements(self):
        ...
        from speech_scribe.gui.enhancements import HistoryDialog, KeyboardShortcuts, SearchWidget
...
class TestModelsDataclass:
    ...
    def test_round_trip(self):
        from speech_scribe.core.models import SegmentResult, TranscriptionResult
