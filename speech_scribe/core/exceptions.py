...
FileNotFoundError = SpeechScribeFileNotFoundError
...
class UnsupportedFormatError(FileError):
    ...
    def __init__(self, file_path: str, file_format: str, supported_formats: list,
        ...
        self.format = file_format  # alias backward-compatible
...
__all__ = [
    ...
    'FileNotFoundError',  # alias para SpeechScribeFileNotFoundError
