...
from speech_scribe.core.exceptions import ModelLoadError, TranscriptionProcessError
...
class TranscriptionThread(QThread):
    ...
    def run(self):
        ...
        try:
            ...
            if result is None:
                raise TranscriptionProcessError(self.audio_path, "Transcrição retornou resultado vazio")
    ...
    def _transcribe_with_progress(self, audio_duration: float) -> dict:
        ...
        if not model:
            raise ModelLoadError(self.model, "Falha ao carregar modelo")
